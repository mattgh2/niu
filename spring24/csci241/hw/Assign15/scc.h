...
private:
    ...
    void handle_end();
    void branchneg_to_linenum(const int & index, const int &line_number, const int &location);
    void branchzero_to_linenum(const int &index, const int &line_number, const int &location);
