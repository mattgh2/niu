...
***************************************************************** 
*                                                               * 
*  CSCI 360-1             ASSIGNMENT 8        SPRING 2025       * 
*                                                               * 
...
*
         LA    2,99              INITIALIZE R1 AS LINE COUNTER
         XREAD RECORD,80         PRIMARY READ INTO RECORD
PROCREC  BC    B'0100',ENDPROC   BRANCH PAST IF RECORD IS EMPTY
*
...
*
         PACK  PEMPID(5),IEMPID(8)   PACK ZONED EMPID
         MVC   IDPTRN(10),=X'21202060202020202020' CREATE EDIT PATTERN
         ED    IDPTRN(10),PEMPID    PUT PACKED EMP ID INTO OUTPUT
         MVC   OEMPID(9),IDPTRN+1   GETS RID OF THE LEADING ZERO
* 
         MVC   OEMPNME(25),IEMPNME  MOVE EMPLOYEE NAME TO DETAIL LINE
*
         PACK  PHRPAY(3),IHRPAY(5) PACK HRPAY
         LA    1,OHRPAY+3          ENSURES PLACEMENT OF DOLLAR SIGN
         MVC   OHRPAY(8),=X'402021204B2020' ADD EDIT PATTERN
         EDMK  OHRPAY(8),PHRPAY  MOVE PACKED FIED INTO PRINTLINE
...
*
         ...
         ED    OHOURS(7),PHOURS  MOVE INTO DETAIL LINE
*
         PACK  PDEDUCT(3),IDEDUCT(5) PACK DEDUCTION AMOUNT
         PACK  PBONUS(3),IBONUS(5)   PACK BONUS AMOUNT
         ZAP   PGRPAY(6),PHOURS(3)   PLACE PHOURS IN PGRPAY
         MP    PGRPAY(6),PHRPAY(3)   MP GROSS PAY BY HOURLY PAY
         SRP   PGRPAY(6),64-2,5      SHIFT 2 TO THE RIGHT & ROUND
         SP    PGRPAY(6),PDEDUCT(3)  SUBTRACT DEDUCTION FROM GROSS PAY
         AP    PGRPAY(6),PBONUS(3)   ADD BONUS AMOUNT TO GROSS PAY
...
*
         C     2,MAXLINES    CHECK IF WE HAVE REACHED 19 LINES
...
*
         LA    2,1(,2)             ADD ONE TO LINE COUNTER
*
